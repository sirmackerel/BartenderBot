...
besides the PR2 to teach them different kinds of behavior. Any humanoid robot could potentially be controlled with {\tt PROTOS} with some slight modification to the source code.
...
and sending data between all of the pieces of the {\tt PROTOS} system.While the
