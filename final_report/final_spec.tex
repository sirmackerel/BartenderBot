...
\section{Ethics}
\label{sec:ethics}As with robotics in general, there are multiple ethical
points to consider when examining a teleoperation system. (TODO - combine)
There are two main entities which merit consideration 
when evaulating a teleoperation teaching system in terms of ethics. \\
...
otherwise control) the PR2. Likewise, it should be ensured that users are
not able to corrupt previously recorded motion sequences, whether by accident 
or intentionally.
